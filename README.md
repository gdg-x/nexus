...
If you receive an error message `"You do not have permission to publish to gdgnexus.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add em.14@hotmail.com,valscarlatadev@gmail.com,splaktar@gmail.com,kpaul86+github@gmail.com`
